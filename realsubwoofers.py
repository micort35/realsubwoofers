...
def tweet():
    ...
    #get random follower's handle and message
    ...
    message = random.choice(messages).format(id)

    #get random media from library to pair with message
    images = './assets/media/'
    image = random.choice(os.listdir(images))
    image_path = images + image

    #attempt to tweet, log variables and the attempt outcome
